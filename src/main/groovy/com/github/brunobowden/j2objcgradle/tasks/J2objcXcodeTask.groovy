...
class J2objcXcodeTask extends DefaultTask {
    ...
    @OutputFile
    File getPodspecFile() { new File(project.buildDir, "podspec") }
    ...
    def pod(IncrementalTaskInputs inputs) {
        ...
        String srcDirRelativeToBuildDir = project.buildDir.toURI().relativize(srcDir.toURI())
        ...
        String podspecFileContents =
                ...
                "s.source_files = '${srcDirRelativeToBuildDir}**/*.{h,m}'\n" +
                "s.public_header_files = '${srcDirRelativeToBuildDir}**/*.h'\n" +
                ...
                "'LIBRARY_SEARCH_PATHS' => '${getJ2ObjCHome()}/lib' }\n" +
                "end\n"
        ...
        if (!podFile.exists()) {
            ...
            def message =
                    ...
                    "WITHIN THAT XCODE DIRECTORY, create the podfile with this command:\n" +
                    "    pod init\n" +
                    "\n" +
            ...
            checkPodDefExistence(podFile, xcodeTarget, podName)
